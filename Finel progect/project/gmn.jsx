        ...
        <form onSubmit={handl} className="space-y-6">
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="mt-4">
              ...
              >
                {loading ? 'Generate Content' : 'loading  ...'}
              </button>
            </div>
          </div>
          ...
          {inpt && (
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">AI says:</h2>
          ...
          {forint.length > 0 && (
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">your Prompts</h2>
